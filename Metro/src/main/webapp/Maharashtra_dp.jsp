...
<title>Maharashtra booking</title>
      ...
      .sub2
        {
         ...
         border-radius:4px;
         position: absolute;
         transform: translate(296px,123.5px);
...
try{
	...
	String sql="select * from maha where f='"+start+"' and t='"+destination+"' order by f_time asc";
...
<span><button class="sub2" onclick="window.location='Maharashtra.jsp';">Cancel</button> </span>
</footer>
</body>
</html>