...
<h1>Tamil Nadu Available Stations</h1>
...
<img src="photos/chnmetror.webp" width="250" style="margin:10px">
<div class="state"><h1 class="login" >TamilNadu Metro</h1></div>
<form action="TN.jsp" method=post class="from">
  <div class="bo">
    <div class="fr">
      <label >From:</label>
  	  <select name="fplacet" required>
    ...
    <div class="tr">
      <label for="tplacet">To:</label>
  	  <select name="tplacet" class="ts" required>
  		<option value="" disabled selected hidden>Select</option>
 	    <option value="Chennai Central">Chennai Central</option>
 	    <option value="Thirumangalam">Thirumangalam</option>  
  	    <option value="Koyambedu">Koyambedu</option>
  ...
  {%>
	  <p class="error" >Choose Appropriate Route</p>
 <% }%></div>
  </div>
  <div>
...
<span><button class="sub2" onclick="window.location='TamilNadu.jsp';">Clear</button> 
</span>
</body>
</html>